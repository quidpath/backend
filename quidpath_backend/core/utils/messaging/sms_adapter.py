...
class SMSAdapter(MessagingAdapter):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        # Get provider config
        provider_config = self.PROVIDER_TYPES.get(self.provider_type, self.PROVIDER_TYPES['africas_talking'])
    ...
    def _send_twilio(
        ...
        from_number = metadata.get('from_number', self.shortcode) if metadata else self.shortcode
