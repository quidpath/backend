from Authentication.models.logbase import Notification, NotificationType, Transaction
...
class NotificationService:
    ...
    def create_notification(self, corporate, title, destination, message, notification_type, state):
    ...
    def update_transaction_notification_log(self, transaction: Transaction, response: dict):
