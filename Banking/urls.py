...
from Banking.views.Transactions import create_transaction, get_transaction, list_transactions, update_transaction, \
    delete_transaction
from Banking.views.reconciliation import add_bank_reconciliation, list_bank_reconciliations, update_bank_reconciliation, \
    delete_bank_reconciliation
from Banking.views.transfer import (
    create_internal_transfer,
    list_internal_transfers,
    update_internal_transfer,
    delete_internal_transfer
)
from Banking.views.charge import (
    add_bank_charge,
    list_bank_charges,
    update_bank_charge,
    delete_bank_charge
...
urlpatterns = [
    ...
    path("internal-transfer/update/", update_internal_transfer, name="update_internal_transfer"),
    path("internal-transfer/delete/", delete_internal_transfer, name="delete_internal_transfer"),

    path("bank-reconciliation/create/", add_bank_reconciliation, name="add_bank_reconciliation"),
    path("bank-reconciliation/list/", list_bank_reconciliations, name="list_bank_reconciliations"),
    path("bank-reconciliation/update/", update_bank_reconciliation, name="update_bank_reconciliation"),
