...
def get_payment_status(request, payment_id):
    ...
    try:
        ...
        corporate_users = registry.database(
            ...
            operation="filter",
            data={"customuser_ptr_id": user.get("id") if isinstance(user, dict) else getattr(user, 'id', None), "is_active": True}
        )
        ...
        return ResponseProvider(message="An error occurred while retrieving payment status", code=500).exception()
