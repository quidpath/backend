...
class OrganizationSubscription(BaseModel):
    ...
    corporate = models.ForeignKey(
        Corporate, on_delete=models.CASCADE, related_name="subscriptions"
    )
...
class OrganizationInvoice(BaseModel):
    ...
    corporate = models.ForeignKey(
        Corporate, on_delete=models.CASCADE, related_name="billing_invoices"
    )
...
class OrganizationPayment(BaseModel):
    ...
    corporate = models.ForeignKey(
        Corporate, on_delete=models.CASCADE, related_name="billing_payments"
    )
