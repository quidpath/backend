...
class DocumentAttachment(BaseModel):
    ...
    corporate = models.ForeignKey(
        Corporate, on_delete=models.CASCADE, related_name="attachments"
    )
    uploaded_by = models.ForeignKey(
        CorporateUser, on_delete=models.PROTECT, related_name="uploaded_attachments"
    )
    ...
    is_public = models.BooleanField(
        default=False
    )  # Public attachments can be accessed without auth
