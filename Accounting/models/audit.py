...
class AuditLog(BaseModel):
    ...
    user = models.ForeignKey(CorporateUser, on_delete=models.SET_NULL, null=True, blank=True, related_name="audit_logs")
    corporate = models.ForeignKey(Corporate, on_delete=models.CASCADE, related_name="audit_logs")
    ...
    object_id_str = models.CharField(max_length=255, blank=True, null=True)  # String representation of object ID
