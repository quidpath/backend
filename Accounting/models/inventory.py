...
class Warehouse(BaseModel):
    ...
    corporate = models.ForeignKey(
        Corporate, on_delete=models.CASCADE, related_name="warehouses"
    )
...
class InventoryItem(BaseModel):
    ...
    corporate = models.ForeignKey(
        Corporate, on_delete=models.CASCADE, related_name="inventory_items"
    )
    name = models.CharField(max_length=255)
...
class StockMovement(BaseModel):
    ...
    corporate = models.ForeignKey(
        Corporate, on_delete=models.CASCADE, related_name="stock_movements"
    )
    ...
    created_by = models.ForeignKey(
        CorporateUser, on_delete=models.PROTECT, related_name="created_stock_movements"
    )
