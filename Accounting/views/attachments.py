...
def upload_attachment(request):
    ...
    try:
        ...
        if not content_type_name or not object_id:
            return ResponseProvider(message="content_type and object_id are required", code=400).bad_request()
        ...
        try:
            ...
            return ResponseProvider(message=f"Invalid content_type: {content_type_name}", code=400).bad_request()
        ...
        return ResponseProvider(message=f"Error uploading attachment: {str(e)}", code=500).exception()
...
def list_attachments(request):
    ...
    try:
        ...
        return ResponseProvider(message=f"Error listing attachments: {str(e)}", code=500).exception()
...
def delete_attachment(request, attachment_id):
    ...
    try:
        ...
        if not attachment:
            return ResponseProvider(message="Attachment not found", code=404).bad_request()
        ...
        return ResponseProvider(message=f"Error deleting attachment: {str(e)}", code=500).exception()
